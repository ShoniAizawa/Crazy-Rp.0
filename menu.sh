...
# ╚══════════════════════════════════════════════════════════════════════════════════════════╝
echo -e "\e[1;33m⚠️  Use only on authorized targets ⚠️\e[0m\n"
...
while true; do
  ...
  echo -e "\e[1;36m║  ⠀⠈⠉⠉⠋⠉⠉⠋⠉⠉⠉⠋⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠋⡟⠉⠉⡿⠋⠋⠋⠉⠉⠁                   ║\e[0m"
  echo -e "\e[1;36m║                                                                                          ║\e[0m"
  echo -e "\e[1;36m║                  Advanced AI-Driven Penetration Testing Tool                              ║\e[0m"
  echo -e "\e[1;36m║                      Version 1.3.0 - Code Name (Hestia)                                  ║\e[0m"
  echo -e "\e[1;36m╚══════════════════════════════════════════════════════════════════════════════════════════╝\e[0m"
  echo -e "\e[1;33m⚠️  Use only on authorized targets ⚠️\e[0m\n"
